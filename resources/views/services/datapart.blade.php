                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="mb-2">
                                <a id="edit-role" href="javascript:void(0);" class="menu-link px-3 text-warning"
                                    data-bs-toggle="modal" data-bs-target="#edit_service" data-name="{{ $service->nom }}"
                                    data-url="{{ route('services.edit', ['service' => $service->id]) }}">
                            ...
                            <li class="mb-2">
                                <a id="supprimer_role" href="javascript:void(0);" class="menu-link px-3 text-danger"
                                    data-url="{{ route('services.delete', ['service' => $service->id]) }}">
