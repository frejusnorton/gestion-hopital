...
<html lang="en">
	...
	<head>
		...
		<meta name="description" content="Une plateforme moderne dédiée aux services de santé, aux professionnels médicaux et aux patients. Prenez rendez-vous, accédez à des conseils médicaux et bien plus encore." />
		<meta name="keywords" content="santé, médecine, hôpital, docteur, pharmacie, consultation, rendez-vous médical, soins, bien-être, plateforme santé" />
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<meta charset="utf-8">
		<meta property="og:locale" content="fr_FR">
		<meta property="og:type" content="website">
		<meta property="og:title" content="Polyclinique Biosso  - Votre partenaire médical">
		<meta property="og:description" content="Accédez facilement aux soins médicaux grâce à notre plateforme de santé en ligne. Trouvez des médecins, pharmacies et services adaptés à vos besoins.">
		{{-- <meta property="og:url" content="https://votre-site-sante.com"> --}}
									...
									<div class="me-n2">
										...
										<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
											...
											<div class="menu-item px-5">
												<a href="../../demo8/dist/authentication/flows/basic/sign-in.html" class="menu-link px-5">Se déconnecter</a>
											</div>
											<!--end::Menu item-->
											<!--begin::Menu separator-->
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										...
										<div class="menu-item">
											<a class="menu-link" href="{{route('medecin.index')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
					...
					<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="https://keenthemes.com"  class="text-gray-800 text-hover-primary">Polyclinique Biosso</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Menu-->
						...
						<div class="mb-0">
							...
							<div class="mb-7">
								<div class="d-flex flex-stack">
									...
									<a href="https://themeforest.net/licenses/standard" class="fw-bold" >License FAQs</a>
								</div>
							</div>
							<!--end::Header-->
							<!--begin::License-->
							...
							<div class="rounded border border-dashed border-gray-300 py-4 px-6 mb-5">
								<div class="d-flex flex-stack">
									...
									<div class="text-nowrap">
										<a href="https://keenthemes.com/contact/" class="btn btn-sm btn-success" >Contact Us</a>
									</div>
								</div>
							</div>
							<!--end::License-->
