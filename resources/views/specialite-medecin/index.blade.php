@extends('main.index')
@section('title', 'Listes des spécialités')
@section('toolbar')
    <div
        ...
        <div class="page-title d-flex flex-column me-5">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
                ...
                <!--begin::Item-->
                <li class="breadcrumb-item text-muted">
                    <span class="text-muted text-hover-primary">Gestion des specialtes d'un médécin</span>
                </li>
                <!--end::Item-->
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#add_specialite">
                                    <i class="ki-duotone ki-plus fs-2"></i> Ajouter une spécialté
                                </button>
                                <!--end::Add user-->
                            </div>
                            <!--end::Toolbar-->
                    ...
                    <div class="card-body py-4">
                        ...
                        <div id="kt_table_users_wrapper" class="dt-container dt-bootstrap5 dt-empty-footer">
                            <div id="datapart" class="table-responsive">
                                @include('specialite-medecin.datapart')
                            </div>
...
@endsection
@include('specialite-medecin.create')
@include('specialite-medecin.edit')
@section('scripts')
    @include('specialite-medecin.js')
@endsection
