...
@section('title', 'Listes des professions')
@section('toolbar')
        ...
        <div
            ...
            <div class="page-title d-flex justify-content-center flex-column me-5">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
                    ...
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-gray-900"> Listes des professions
                    </li>
                    <!--end::Item-->
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <button type="button" class="btn btn-light-primary me-3" data-bs-toggle="modal"
                                    data-bs-target="#kt_modal_export_profession">
...
@endsection
@include('profession.create')
@include('profession.edit')
@include('profession.export')


@section('scripts')
    @include('profession.js')
@endsection