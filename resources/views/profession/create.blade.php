    ...
    <div class="modal-dialog modal-dialog-centered mw-500px">
        <div class="modal-content">
            <div class="modal-header" id="kt_modal_add_user_header">
                <h2 class="fw-bold" id="modaltitle">Ajouter une profession</h2>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <form id="kt_modal_add_permission_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                    action="{{ route('profession.create') }}" method="post">
                    @csrf
                    <!--begin::Input group-->
                    <div class="fv-row mb-7 fv-plugins-icon-container">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input class="form-control required form-control-solid" placeholder="Entrer le nom"
                            name="name">
                        <!--end::Input-->
                        <div
