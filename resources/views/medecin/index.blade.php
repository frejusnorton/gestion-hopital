@extends('main.index')
@section('title', 'Listes des médécins')
@section('toolbar')
    <div
        ...
        <div class="page-title d-flex flex-column me-5">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
                ...
                <!--begin::Item-->
                <li class="breadcrumb-item text-muted">
                    <span class="text-muted text-hover-primary">Listes des médécins</span>
                </li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-user-table-filter="search" id="search"
                                    ...
                                    placeholder="Rechercher un médécin">
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    ...
                                    <i class="ki-duotone ki-plus fs-2"></i> Ajouter un médécin
                                </button>
                                <!--end::Add user-->
                            </div>
                            <!--end::Toolbar-->
...
@endsection
@include('medecin.create')
@include('medecin.edit')
@section('scripts')
    @include('medecin.js')
@endsection
