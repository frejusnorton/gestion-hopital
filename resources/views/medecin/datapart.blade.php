<table class="table align-middle table-row-dashed fs-6 gy-5 dataTable" id="kt_table_users" style="width: 100%;">
    <thead>
        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
            ...
            <th class="min-w-125px dt-orderable-asc dt-orderable-desc" data-dt-column="1">
                <span class="dt-column-title text-primary" role="button">Prénom</span>
                <span class="dt-column-order"></span>
            </th>
            <th class="min-w-125px dt-orderable-asc dt-orderable-desc" data-dt-column="1">
                <span class="dt-column-title text-primary" role="button">Email</span>
                <span class="dt-column-order"></span>
            </th>
            <th class="min-w-125px dt-orderable-asc dt-orderable-desc" data-dt-column="1">
                <span class="dt-column-title text-primary" role="button">Telephone</span>
                <span class="dt-column-order"></span>
            </th>
            <th class="min-w-125px dt-orderable-asc dt-orderable-desc" data-dt-column="1">
                <span class="dt-column-title text-primary" role="button">Sexe</span>
                <span class="dt-column-order"></span>
            </th>
    ...
    <tbody class="text-gray-600 fw-semibold">
        @forelse ($medecins as $medecin)
            <tr>
                ...
                <td class="align-middle">
                    {{ $medecin->created_at->format('d/m/Y à H:i') }}
                </td>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="mb-2">
                                <a id="edit-role" href="javascript:void(0);" class="menu-link px-3 text-warning"
                                    ...
                                    data-name="{{ $medecin->nom }}"
                                    data-url="{{ route('medecin.edit', ['specialite' => $medecin->id]) }}">
                            ...
                            <li class="mb-2">
                                <a id="supprimer_role" href="javascript:void(0);" class="menu-link px-3 text-danger"
                                    data-url="{{ route('medecin.delete', ['medecin' => $medecin->id]) }}">
                                    <i class="bi bi-trash text-danger"></i> Supprimer
                                </a>
                            </li>
                            <li>
                                <a id="permission_role" href="javascript:void(0);" class="menu-link px-3 "
                                    data-url="#" data-statut="#">
        ...
        @empty
        <tr>
            <td colspan="3" class="text-center">Aucun médécin disponible</td>
        </tr>
        @endforelse
    </tbody>
</table>
...
<!-- Pagination -->
<div class="mt-3">
    {{ $medecins->links('pagination.custom') }}
</div>
