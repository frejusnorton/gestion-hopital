<div class="modal fade" id="kt_modal_update_service" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered mw-550px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bold">Mise à jour service</h2>
                <!--end::Modal title-->
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    ...
                    <div class="d-flex flex-stack flex-grow-1 ">
                        ...
                        <div class=" fw-semibold">
                            ...
                            <div class="fs-6 text-gray-700 "><strong class="me-1">Avertissement !</strong> En modifiant
                                le nom du service, vous pourriez perturber le fonctionnement des permissions du
                ...
                <!--begin::Form-->
                <form id="kt_modal_update_service_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                    method="post">
                    @csrf
                    <!--begin::Input group-->
