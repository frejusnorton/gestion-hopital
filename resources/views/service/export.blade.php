...
<div class="modal fade" id="kt_modal_export_service" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered mw-550px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bold">Exporter les services</h2>
                <!--end::Modal title-->
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form id="kt_modal_export_service_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                    action="{{ route('service.export') }}" method="post">
                    @csrf
                    <!--begin::Input group-->
